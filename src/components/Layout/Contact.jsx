  ...
  return (
    <>
      <div className="section after bg-zinc-800">
          ...
          <div className="w-full flex flex-col text-center text-pretty mt-20 justify-center items-center px-3 md:px-6 lg:flex-col xl:mt-24">
            <p className="text-2xl md:text-3xl lg:text-5xl font-title2 text-stone-700 max-w-[1000px] 2xl:text-[3.3rem] 2xl:max-w-[1100px]">
              ...
              <span className="text-red-500">
                sonic vitality and infectious energy
              </span>{" "}
              behind the decks
            </p>
        ...
        >
          <div className="w-full relative font-title h-[95vh] lg:h-screen flex flex-col justify-start items-center md:justify-center lg:w-1/2 lg:self-start ">
          ...
          <div className="hidden lg:w-1/2 lg:flex items-center justify-center relative mt-12 ">
            <div className="lg:w-[200px] lg:h-[200px] border border-red-500 z-50  absolute group hover:rotate-180 duration-700 2xl:w-[220px] 2xl:h-[220px]"></div>
            <div className="lg:w-[200px] lg:h-[200px] border border-stone-600 z-40 absolute  left-[50%] bottom-[50%] hover:rotate-180 duration-700 2xl:w-[220px] 2xl:h-[220px]"></div>
            <div className="lg:w-[200px] lg:h-[200px] border border-stone-700 z-50 absolute right-[50%] top-[50%] hover:rotate-180 duration-700 2xl:w-[220px] 2xl:h-[220px]"></div>
          </div>
        </section>
      </div>
    </>
