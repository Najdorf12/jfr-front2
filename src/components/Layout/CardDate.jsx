...
const CardDate = () => {
  return (
    <div className="font-title relative  text-balance text-sm pl-[6px] pb-2 md:pl-6 flex w-full text-stone-500 border-b border-stone-300 lg:text-base  xl:pl-[9%] xl:pr-[3%]">
      ...
      <div className="flex flex-col w-[60%] justify-center gap-3 pl-6 md:pl-[6%]">
      ...
      <div className="flex absolute right-6 top-2 gap-2 z-20 w-[20%] text-stone-500 text-nowrap justify-center items-center md:relative lg:gap-4 lg:text-lg lg:pb-12">
